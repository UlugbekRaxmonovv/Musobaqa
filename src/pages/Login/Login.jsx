...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#fff] px-4">
        <div className="w-full max-w-[320px] bg-white rounded-xl shadow-2xl">
          <div className="flex items-center justify-center border-b border-gray-100 py-4 bg-white rounded-t-lg">
          ...
          <div className="px-10 py-4">
            ...
            >
              ...
              >
                <Input placeholder="Телефон" className="h-12 text-lg" />
              </Form.Item>
              ...
              <Form.Item>
                <Button
                  ...
                  loading={loading}
                  htmlType="submit"
                  className="w-full h-12 text-lg bg-[#000] text-white rounded-md"
                >
                  {loading ? "" : "Войти"}
                </Button>
                <div className="flex justify-center space-x-4 py-3 px-4 mt-2">
                  <button className="p-2 bg-gray-100 hover:bg-gray-200 rounded-full transition">
                    ...
                    >
                      <path d="M15.073 2H8.938C3.332 2 2 3.333 2 8.927v6.136C2 20.667 3.323 22 8.927 22h6.136C20.667 22 22 20.677 22 15.073V8.938C22 3.332 20.677 2 15.073 2z" />
                    </svg>
                  </button>
